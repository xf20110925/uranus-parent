 ...
 */
public class WeixinArticleDynamicHandleTest {
    ...
    public void testHandle() throws InterruptedException, ConfigurationException {
        ...
        Message<CollectCondition> message = new Message<CollectCondition>("uranus-server", "weixin_article_dynamic", 1, "1.0.0", collectCondition);
        ...
        weixinArticleDynamicHandle.handle(bus, message);
        Thread.sleep(3000);
    }
