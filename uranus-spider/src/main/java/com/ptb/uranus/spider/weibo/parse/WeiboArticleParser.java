...
public class WeiboArticleParser {
    ...
    public WeiboArticle getWeiboArticleByArticleUrl(String articleUrl) throws Exception {
        ...
        if (weiboArticle == null) {
             weiboArticle = parseFromPcPageByWebDriver(articleUrl.replace("m.weibo.cn", "www.weibo.com"));
        }
        return weiboArticle;
    }
    ...
    private WeiboArticle parseFromPcPageByHttpClient(String aritcleUrl) throws Exception {
        WeiboArticle weiboArticle = new WeiboArticle();
        try {
            int i = 3;
