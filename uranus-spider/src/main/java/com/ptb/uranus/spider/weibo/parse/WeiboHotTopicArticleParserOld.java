 ...
 * @Time: 11:48
 */
public class WeiboHotTopicArticleParserOld implements BaseWeiboParser {
	Queue<CookieStore> cookieQueue = new LinkedList<>();

	public WeiboHotTopicArticleParserOld() {
	...
	public static void main(String[] args) {
		WeiboHotTopicArticleParserOld parser = new WeiboHotTopicArticleParserOld();
